...
<body class="bg-gray-100">
   ...
   <section class="relative z-10 bg-primary py-[120px]" style="height: 1024px; width: 100%; overflow: hidden; position: fixed; padding-top: 110px;">
         ...
         <div class="-mx-4 flex">
            <div class="w-full px-4">
               <div class="mx-auto max-w-[400px] text-center">
                  ...
                  <a href="{{ route('home') }}" class="inline-block rounded-lg border border-white px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-white hover-text-black relative z-20">
                     Go To Home
                  </a>
